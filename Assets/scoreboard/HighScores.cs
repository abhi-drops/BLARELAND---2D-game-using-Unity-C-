...
{
    const string privateCode = "GvCmffkGkUGASpNF2EC1Xw3iy1eBzFZE-iWwIZbLDClQ";  //Key to Upload New Info
    const string publicCode = "646e0b138f40bb7d84ecb11e";   //Key to download
